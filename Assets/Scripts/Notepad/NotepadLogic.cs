...
public class NotepadLogic : Singleton<NotepadLogic>
{
    ...
    private void StartPattern() {
        ...
        //sfx, vfx, etc
        AudioControl.Instance.PlaySFX("Node1", PlayerController.Instance.gameObject, 0f, 0.8f);
    }
    ...
    private void AddToPattern(int num) {
        ...
        AudioControl.Instance.PlaySFX(nodeName, PlayerController.Instance.gameObject, 0f, 0.8f);
        PrintPattern();
    }
    ...
    private void OnInvalidPattern()
    {
        ...
        AudioControl.Instance.PlaySFX("NodeWrong", PlayerController.Instance.gameObject, 0f, 0.8f);
